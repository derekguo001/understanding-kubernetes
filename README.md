...
- [调度算法详解](kube-scheduler/scheduler-plugins/overview.md)
  ...
  - [DefaultPreemption](kube-scheduler/scheduler-plugins/default-preemption/overview.md)
    - [第一步:找到所有可以抢占的目标节点](kube-scheduler/scheduler-plugins/default-preemption/1.md)
    - [第二步:选择一个最佳的抢占目标节点](kube-scheduler/scheduler-plugins/default-preemption/2.md)
    - [第三步:实施抢占动作](kube-scheduler/scheduler-plugins/default-preemption/3.md)
